...
public class Customer implements CustomerPrototype {
    ...
    public CustomerPrototype clone() {
        return new Customer(id, name, age, gender, dob, height, weight, language, job, position, address, contact, email, membership, purchase, point, rank, discount, register, status);
    }
